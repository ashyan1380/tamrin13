...
//   }, [])
  ...
  return (
    <div className="modal">
      <div style={{background:theme.background,color:"rgb(37, 39, 49)"}} className="modal-body">
        <div className="row-up">
            <div className="img">
          <img className="max-flag" src={info.flag} />
          </div>
          <div style={{background:theme.background2,color:"rgb(37, 39, 49)"}}  className="info">
            <h4>{info.name}</h4>
            <p>
        ...
        <div  className="row-down">
          <div style={{background:theme.background2,color:"rgb(37, 39, 49)"}} className="code">
